...
enum DashboardKeys {
    ...
    enum Activities {
        ...
        static let weeklyLiftGoal = "dashboard.activities.weeklyLiftGoal"
        ...
        // Activity Formatter Support
        static let oneFood = "dashboard.activities.oneFood"
        static let multipleFood = "dashboard.activities.multipleFood"
